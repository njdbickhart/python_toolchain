...
first <- paste0(c("figures/", args[1], "_facet_cov_by_comp_scatter.pdf"))
second <- paste0(c("figures/", args[1], "_top80_cov_by_comp.pdf"))
third <- paste0(c("figures/", args[1], "_ridge_top95_coverage.pdf"))
